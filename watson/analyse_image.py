...
with open(lieorstand_path, 'rb') as images_file:
    ...
    parameters = json.dumps({'threshold': 0.5, 
                             'classifier_ids': ['RemoteTriage_482484271', 'default']})
    ...
    for im in results['images']:
        ...
        for clasf in im['classifiers']:
            ...
            if clasf_name is u'Remote Triage':
                for item in clasf['classes']:
                    if item['class'] is u'Prone':
                        situation.append('Prone person probability (%0.0f%%)' % (item['score'] * 100.0))
                    else:
                        print(item['class'])
                        print(item['score'])
        # Find the right face information
        for face_im in faces['images']:
            if face_im['image'] is im['image']:
                for face in face_im['faces']:
                    face_type.append('%s (age %d-%d)' % (face['gender']['gender'], face['age']['min'], face['age']['max'])) 
                    pos = (face['face_location']['left'], face['face_location']['top'], face['face_location']['width'], face['face_location']['height'])
                    face_pos.append(pos)
             
        show_image('LieOrStand2/' + filename, situation, face_type, face_pos)
...
#    faces = {u'images': [{u'image': u'LieOrStand2.zip/D.jpg', u'faces': [{u'gender': {u'gender': u'MALE', u'score': 0.9732676}, u'age': {u'max': 28, u'score': 0.99969834, u'min': 25}, u'face_location': {u'width': 175, u'top': 644, u'left': 1170, u'height': 205}}]}, {u'image': u'LieOrStand2.zip/A.jpg', u'faces': [{u'gender': {u'gender': u'MALE', u'score': 0.99685293}, u'age': {u'max': 40, u'score': 0.2921676, u'min': 32}, u'face_location': {u'width': 135, u'top': 747, u'left': 1730, u'height': 137}}]}, {u'image': u'LieOrStand2.zip/B.jpg', u'faces': [{u'gender': {u'gender': u'MALE', u'score': 0.9846315}, u'age': {u'max': 28, u'score': 0.83206326, u'min': 24}, u'face_location': {u'width': 136, u'top': 757, u'left': 1296, u'height': 146}}]}, {u'image': u'LieOrStand2.zip/C.jpg', u'faces': [{u'gender': {u'gender': u'MALE', u'score': 0.8604275}, u'age': {u'max': 41, u'score': 0.23711067, u'min': 32}, u'face_location': {u'width': 179, u'top': 794, u'left': 724, u'height': 190}}]}, {u'image': u'LieOrStand2.zip/IMG_4132.jpg', u'faces': []}], u'images_processed': 5}
